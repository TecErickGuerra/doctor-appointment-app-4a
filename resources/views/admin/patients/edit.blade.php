...
@php
    ...
    //Si hay errores, buscamos en qué grupo estan para abrir esa pestaña automáticamente
            ...
            <x-wire-card>
                <div x-data="{ tab: '{{ $initialTab }}' }">
                    ...
                    <div class="px-4 mt-4">
                        ...
                        {{-- Cotenido de Tab1: Datos personales --}}
                        ...
                        {{-- Cotenido de Tab2: Datos Antecedentes --}}
                        ...
                        {{-- Cotenido de Tab4: Contacto de emergencia --}}
